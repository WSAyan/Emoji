...
public class CustomEmoji extends Emoji {
    ...
    public CustomEmoji(@NonNull final int[] codePoints, @NonNull final String[] shortcodes, final int icon, final int y,
    ...
    public CustomEmoji(final int codePoint, @NonNull final String[] shortcodes, final int icon, final int y,
